...
| 文件 | 内容与证据等级 |
| --- | --- |
| [observations.json](observations.json) | 13 项实测、失败、前提不成立、观测不足、恢复及历史记录；保留字段、参数、人工观察和限制 |
...
| [BZ-HID-04.json](evidence/BZ-HID-04.json) | 用户在对话中粘贴的最新共存成功输出的关键事件摘录；**不是原始 stdout 文件** |
| [validation.json](validation.json) | 原归档及隐私配置调整后的离线验证命令、输出摘录和退出码；不属于实机证据 |
| [archive-manifest.json](archive-manifest.json) | 本目录实验、辅助诊断、材料及关联工具的 SHA-256；不包含清单自身、Git 或私有状态 |
